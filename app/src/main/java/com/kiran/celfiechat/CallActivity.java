...
import com.kiran.celfiechat.Models.InterfaceJava;
import com.kiran.celfiechat.databinding.ActivityVideoCallBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.voice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(isAudio){
                    binding.voice.setImageResource(R.drawable.btn_unmute_pressed);
                } else {
                    binding.voice.setImageResource(R.drawable.btn_mute_pressed);
                }
            }
        });
        ...
        binding.video.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(isVideo){
                    binding.video.setImageResource(R.drawable.videocall);
                } else {
                    binding.video.setImageResource(R.drawable.videomute);
                }
            }
        });
